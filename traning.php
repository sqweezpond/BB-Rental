       ...
       <!-- CONTENT -->
        ...
        <div class="container pb-5">
            ...
            <div class="row mt-4">
                <div class="col-xl-4 col-lg-4 col-md-4">
                  <div class="tran-overlay-image">
                    <img src="assets/images/traning/tran-1.jpg" class="tran-image-full"/>
                  </div>
                </div>
                <div class="col-xl-8 col-lg-8 col-md-8">
                   <div class="tran-font">ระเบียบคามปลอดภัย</div>
            ...
            <div class="row mt-4">
                <div class="col-xl-4 col-lg-4 col-md-4">
                  <div class="tran-overlay-image">
                    <img src="assets/images/traning/tran-2.jpg" class="tran-image-full"/>
                  </div>
                </div>
                <div class="col-xl-8 col-lg-8 col-md-8">
            ...
            <div class="row mt-4">
                <div class="col-xl-4 col-lg-4 col-md-4">
                  <div class="tran-overlay-image">
                    <img src="assets/images/traning/tran-3.jpg" class="tran-image-full"/>
                  </div>
                </div>
                <div class="col-xl-8 col-lg-8 col-md-8">
